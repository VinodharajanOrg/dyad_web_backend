...
export const DyadSearchReplace: React.FC<DyadSearchReplaceProps> = ({
  ...
  // NOTE: Bypass search and replace feature - show content without Search & Replace badge and click events
  return (
    <div className="my-2">
      {/* NOTE: Bypass search and replace feature - hide header with badge and expand/collapse controls */}
      {/* Original header code commented out:
      <div
      ...
      */}
      ...
      {/* NOTE: Bypass search and replace feature - always show content directly without expand/collapse */}
