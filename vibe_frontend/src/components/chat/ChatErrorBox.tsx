...
export function ChatErrorBox({
  ...
  if (isDyadProEnabled && error.includes("ExceededBudget:")) {
    ...
    //       <ExternalLink
    //         href="https://academy.dyad.sh/subscription?utm_source=dyad-app&utm_medium=app&utm_campaign=exceeded-budget-error%22
    //         variant="primary"
    //       >
...
//         if (ipcClient) {
//           (ipcClient as any).openExternalUrl(href);
//         }
//       }}
//     >
//       <span>{children}</span>
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      ...
                      if (props.href) {
                        const ipcClient = IpcClient.getInstance();
                        if (ipcClient) {
                          (ipcClient as any).openExternalUrl(props.href);
                        }
                      }
                    }}
