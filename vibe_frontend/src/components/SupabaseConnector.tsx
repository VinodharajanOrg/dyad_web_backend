              ...
              >
                <div className="flex items-center gap-2">
                  <img
                    src={
                      isDarkMode
                        ? "/supabase/supabase-logo-wordmark--dark.svg"
                        : "/supabase/supabase-logo-wordmark--light.svg"
                    }
                    alt="Supabase Logo"
    ...
    <div className="flex flex-col space-y-4 p-4 border rounded-md">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <img
          ...
          src={
            isDarkMode
              ? "/supabase/connect-supabase-dark.svg"
              : "/supabase/connect-supabase-light.svg"
          }
