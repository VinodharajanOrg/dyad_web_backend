    ...
    <div className="min-h-screen px-8 py-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6">
          {/* NOTE: General Settings - Visible to all users */}
          <GeneralSettings appVersion={appVersion} />
          {/* NOTE: Workflow Settings - Temporarily hidden, uncomment when needed */}
          {/* <WorkflowSettings /> */}

          {/* NOTE: AI Settings and Provider Settings - Only visible to admin users */}
          {isAdmin && (
            <>
              <AISettings />
              <div
          ...
          {/* NOTE: Telemetry - Temporarily hidden, uncomment when needed */}
          {/* <div className="space-y-6">
            <div
              id="telemetry"
          ...
          {/* NOTE: Experiments Section - Temporarily hidden, uncomment when needed */}
          {/* <div
            id="experiments"
            className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6"
          >
            ...
            <div className="space-y-4">
              <div className="space-y-1 mt-4">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <a
                    onClick={() => {
                      openExternalUrl("https://git-scm.com/downloads");
                    }}
          ...
          {/* NOTE: Danger Zone - Temporarily hidden, uncomment when needed */}
          {/* <div
            id="danger-zone"
      ...
      {/* NOTE: ConfirmationDialog - Temporarily hidden, uncomment when needed */}
      {/* <ConfirmationDialog
